...
const Navbar = ({searchTerm, setSearchTerm, user}) => {
  ...
  return (
    <div className="flex gap-2 md:gap-5 w-full mt-5 pb-7">
      ...
      <input type="text" onChange={(e)=>setSearchTerm(e.target.value)} placeholder="Search" value="Search term" onFocus={()=> navigate('/search')} className="w-full bg-white p-2 outline-none"/>
      </div>
